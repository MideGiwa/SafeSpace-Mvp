    ...
    return (
      <div className={styles.page}>
        ...
        <div className={styles.waitingContainer}>
          ...
          <h2 className={styles.waitingTitle}>Waiting for Host</h2>
          ...
          <div className={styles.waitingActions}>
             <button className={styles.btnJoin} onClick={() => setIsActive(true)}>Mock: Host Admits You</button>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.avatarSection}>
          ...
          <div className={styles.avatarWrapper}>
            <img 
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuDX49UZAUbxOaqvg6tY6zTR9lLa6ihwcVcW6HL_Tbm8SauOTS7AQtthFyd8rT5m4--BZ1-5vy7ClI5w7V7jRawT8gBBkidVHG61zXvB3HmX1uEsedhRJwJeX_5n4zQtswtha1hxtwsCWj5OiLmkFI-RuvaHfUDVjjOEDdNPbF71yVqS2ltsQ5S8BjRNxxOvr6euxjy09EHb78srmr5E0ZlhNR4NIyv4r4ixujQXIF1VJ7ccMLsTtg35eYtniJH3XeQhxp-iYAkCLUjx" 
